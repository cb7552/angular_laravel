...
export class MarketingdigitalComponent implements OnInit {
  ...
  ngOnInit(): void 
  {
    ...
    // this.titleService.setTitle('Marketing digital per a professionals | Girohosting');
    // this.metaService.updateTag({name: 'description', content: 'Oferim estudis - Estratègies - Gestions - Objectius i campanyes publicitàries de marketing digital per obtenir èxit online professional | GIROHOSTING'}, 'name="description"');
